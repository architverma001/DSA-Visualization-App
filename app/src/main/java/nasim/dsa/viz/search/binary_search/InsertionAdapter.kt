...
class InsertionAdapter(private val list: ArrayList<Int>, private val list2:ArrayList<Int>, private val list3: ArrayList<Int>, private val context: Context) :
    RecyclerView.Adapter<InsertionAdapter.LinearSearchViewHolder>() {
